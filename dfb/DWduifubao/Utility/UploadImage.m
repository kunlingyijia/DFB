...
- (void)readImageFromAlbum {
    ...
    [_baseVC presentViewController:imagePicker animated:YES completion:nil];//显示相册
}
//拍照
...
-(void)requestAction:(NSString*)Url image:(UIImage*)image{
    ...
    __weak typeof(_baseVC) weakself = _baseVC;
    if (Token.length!= 0) {
        ...
        [[DWHelper shareHelper] requestDataWithParm:[baseReq yy_modelToJSONString] act:@"act=Api/User/requestUpdateUserInfo" sign:[baseReq.data MD5Hash] requestMethod:GET PushVC:_baseVC success:^(id response) {
