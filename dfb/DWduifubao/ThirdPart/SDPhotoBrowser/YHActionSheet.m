...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        UILabel *labelTitle = [[UILabel alloc] initWithFrame:CGRectMake(YH_Edges, 0, Width-YH_Edges*2, rowHeight)];
        labelTitle.tag = 101;
...
- (void)initSubViews{
    ...
    self.tableview = [[UITableView alloc] initWithFrame:CGRectMake(0,Height + tableviewH, Width, tableviewH) style:UITableViewStylePlain];
    ...
    //2.背景view
    self.backgroundView = [[UIView alloc] initWithFrame:CGRectMake(0, Height, Width, Height)];
...
- (void)dismissViewAnimation {
    ...
    self.backgroundView.frame = CGRectMake(0, Height, Width, Height);
