...
- (instancetype) initWithFrame:(CGRect)frame
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        self.X = X;
        self.Y = Y;
        self.tableView = [[UITableView alloc]initWithFrame:CGRectMake(X, Y,  self.menuWidth/3, 40 * self.menuItem.count) style:UITableViewStylePlain];
...

{
    ...
    //[[UIColor whiteColor] setFill];  //设置填充色
     [[UIColor colorWithRed:0 green:0 blue:0 alpha:0.7] setFill];  //设置填充色
